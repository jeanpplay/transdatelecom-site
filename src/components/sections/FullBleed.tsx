...
export function FullBleed({
  ...
  data: {
    ...
    align?: "left"|"center"|"right"; darken?: number;
  ...
  return (
    <section className="relative min-h-[88svh] overflow-clip">
      <BackgroundMedia asset={data.asset} priority />
      <div
        className="absolute inset-0"
        style={{ background: `linear-gradient(180deg, rgba(0,0,0,${overlay+0.2}) 0%, rgba(0,0,0,${overlay}) 50%, rgba(0,0,0,${overlay+0.3}) 100%)` }}
      />
